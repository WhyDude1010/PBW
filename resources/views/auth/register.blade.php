            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="first_name" name="first_name" type="text" class="w-full pl-11 pr-4 py-3.5 bg-cream border border-transparent rounded-xl focus:border-brand focus:bg-white focus:ring-4 focus:ring-brand/10 transition-all text-[14.5px] text-dark placeholder:text-muted/60" placeholder="First Name" required>
                        </div>
                    </div>
                    <div>
                        <label class="block text-[13.5px] font-bold text-dark mb-2" for="last_name">Last Name</label>
                        <input id="last_name" name="last_name" type="text" class="w-full px-4 py-3.5 bg-cream border border-transparent rounded-xl focus:border-brand focus:bg-white focus:ring-4 focus:ring-brand/10 transition-all text-[14.5px] text-dark placeholder:text-muted/60" placeholder="Last Name" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="reg-email" name="email" type="email" class="w-full pl-11 pr-4 py-3.5 bg-cream border border-transparent rounded-xl focus:border-brand focus:bg-white focus:ring-4 focus:ring-brand/10 transition-all text-[14.5px] text-dark placeholder:text-muted/60" placeholder="Email" required autocomplete="email">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="phone" name="phone" type="tel" class="w-full pl-11 pr-4 py-3.5 bg-cream border border-transparent rounded-xl focus:border-brand focus:bg-white focus:ring-4 focus:ring-brand/10 transition-all text-[14.5px] text-dark placeholder:text-muted/60" placeholder="Phone">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="reg-password" name="password" type="password" class="w-full pl-11 pr-12 py-3.5 bg-cream border border-transparent rounded-xl focus:border-brand focus:bg-white focus:ring-4 focus:ring-brand/10 transition-all text-[14.5px] text-dark placeholder:text-muted/60" placeholder="Password" required>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password_confirm" name="password_confirmation" type="password" class="w-full pl-11 pr-4 py-3.5 bg-cream border border-transparent rounded-xl focus:border-brand focus:bg-white focus:ring-4 focus:ring-brand/10 transition-all text-[14.5px] text-dark placeholder:text-muted/60" placeholder="Confirm Password" required>
                    </div>
                </div>
